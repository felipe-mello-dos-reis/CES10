...
int main(){
    int aluno,numalunos,numcadernos,numcanetas,numlapis,numborrachas;   //variaveis inteiras que serao utilizadas
    float precaderno,precaneta,prelapis,preborracha;     //variaveis reais que serao utilizadas

    printf("Digite o numero de alunos:");
    scanf("%d",&numalunos);
    printf("\n");
    aluno = 1;
    while(aluno<=numalunos){     //comando while eh necessario para a repeticao
        ...
        aluno=aluno+1;    //essencial para a repeticao
        }
    printf("\n\n----------------FIM----------------\n\n\n"); system("pause"); return 0;    //o FIM eh exibido para atender tambem ao caso numero de alunos = 0
    }
